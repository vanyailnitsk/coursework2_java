...
<body>
    <%
        Map<Service,Integer> expenseMap = (Map<Service, Integer>) request.getAttribute("expense_categories");
        Map<Service,Integer> incomeMap = (Map<Service, Integer>) request.getAttribute("income_categories");
    %>
